...
*** TODO Arms [0/2]
**** TODO Make sure test pattern is removed for stacking root (around line 149)
**** TODO Add unloadResources funcs
*** TODO Head [0/1]
**** TODO Drums don't stop with the parent sequencer
