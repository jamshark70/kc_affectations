...
** Musical edits [0/5]
*** TODO Feet [0/2] <2010-12-05 Sun>
**** TODO Distinguish locomotive themes?
**** TODO Phrasing!!!
...
*** TODO Fixes to check in [2/3]
**** DONE [#A] Check in WeighBag fix - never mind, I wrote my own
**** DONE Check in voicer releaseNode fix, tell Lorne
**** TODO Nil:asBus numChannels fix - pending cmake/scons discussion
*** TODO Coding fixes [2/6]
...
**** TODO Check whether trig BPs are properly freed & dependency removed
