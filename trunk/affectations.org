...
***** DONE What else?
**** TODO Axial variations [2/3]
***** DONE Shiva: use 3 am's
***** TODO ^^ Needs quiet chords in background - useful elsewhere
...
***** Lifting, tilting, bending - intermix some sweepy chords with 3 levels
***** Locomotive before they pick up Laura
**** TODO Manipulating Laura: Axial theme but with robotic edge (comb filter maybe?)
**** TODO Stephen solo (short!)
